							...
							<tbody>
								...
								<?php else: ?>
									<?php foreach ($rows as $row): ?>
										<tr>
											<td><?php echo htmlspecialchars(fmtMoney($row['salary_min'] ?? null), ENT_QUOTES, 'UTF-8'); ?></td>
											<td><?php echo htmlspecialchars(fmtMoney($row['salary_max'] ?? null), ENT_QUOTES, 'UTF-8'); ?></td>
											<td><?php echo htmlspecialchars(fmtPercent($row['employee_rate'] ?? null), ENT_QUOTES, 'UTF-8'); ?></td>
											<td><?php echo htmlspecialchars(fmtPercent($row['employer_rate'] ?? null), ENT_QUOTES, 'UTF-8'); ?></td>
